...
PACKAGE ?= helm-kserve
XRD_DIR := apis/kserves
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/kserves/standard.yaml
...
EXAMPLES := \
    examples/kserves/minimal.yaml:: \
    examples/kserves/standard.yaml::
